														...
														for (var k = 0; k < obj.length; k++) {
															...
															if (source == 'audio')
																$("<tr><td>"+inx+"</td><td><a target='_blank' href='http://vk.com/id"+obj[k].user_id+"'>"+obj[k].user_id+"</a></td><td>"+obj[k].title+
																	"</td><td>" + obj[k].percent + " %</td><td><a href='"+obj[k].url+"' target='_blank'>открыть</a></td><td><a href='"+obj[k].link+"'>"+obj[k].extr+"</a></td></tr>").insertAfter($("tr:last"));
															if (source == 'video')
																$("<tr><td>"+inx+"</td><td><a target='_blank' href='http://vk.com/id"+obj[k].user_id+"'>"+obj[k].user_id+"</a></td><td>"+obj[k].title+
																	"</td><td>"+obj[k].duration+"</td><td>" + obj[k].percent + " %</td><td><a href='"+obj[k].player+"' target='_blank'>открыть</a></td><td><a href='"+obj[k].link+"'>"+obj[k].extr+"</a></td></tr>").insertAfter($("tr:last"));
															if (source == 'docs')
																$("<tr><td>"+inx+"</td>"+
																	"<td><a target='_blank' href='http://vk.com/id"+obj[k].user_id+"'>"+obj[k].user_id+"</a></td>"+
																	"<td>"+obj[k].title+"</td>"+
															...
															if (source == 'friends')
																$("<tr><td>"+inx+"</td>"+
																	"<td><a target='_blank' href='http://vk.com/id"+obj[k].user_id+"'>"+obj[k].user_id+"</a></td>"+
																	"<td>"+obj[k].first_name+"</td><td>"+obj[k].last_name+"</td><td><a href='"+obj[k].link+"'>"+obj[k].extr+"</a></td></tr>").insertAfter($("tr:last"));
